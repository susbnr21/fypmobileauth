    ...
    render() {
        ...
        return(
            ...
            <ScrollView>
                ...
                <Text style={styles.header}>Select the Number of Workers 👨🏻‍🔧</Text>
                <Text style={styles.note}>(Note: It is not mandatory to select the workers)</Text>
                    ...
                    onPress={() =>
                        this.props.navigation.navigate('Boxs')}>
